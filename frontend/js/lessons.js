...
<p><strong>String:</strong> Strings in Python are sequences of characters enclosed within single quotes (<code>' '</code>) or double quotes (<code>" "</code>). They are used to store text data such as words, sentences, or any sequence of characters. For example, <code>name = "Alice"</code> creates a string variable containing the text Alice. Strings are immutable, meaning once created, they cannot be changed directly. You can perform various operations on strings, such as concatenation (<code>"Hello" + " World"</code>) or repetition (<code>"Hi!" * 3</code>).</p>

<p><strong>Integer:</strong> Integers are whole numbers without a decimal point, such as <code>10</code>, <code>-5</code>, or <code>2025</code>. They are used for mathematical operations like addition, subtraction, multiplication, and division. For example, <code>a = 10</code> and <code>b = 5</code>; printing <code>a + b</code> will display <code>15</code>. Integers are essential in calculations, counters, and loops.</p>

<p><strong>Float:</strong> Floats represent real numbers that contain a decimal point, such as <code>3.14</code> or <code>-0.5</code>. They are used when more precision is required, such as in financial or scientific applications. For example, <code>price = 99.99</code> and <code>tax = 0.18</code>; printing <code>price * tax</code> gives a float result. Mixing integers and floats in calculations automatically converts the result to a float for precision.</p>
...
<p><strong>Boolean:</strong> Booleans represent one of two values: <code>True</code> or <code>False</code>. They are often used in conditional statements and logical comparisons. For instance, <code>is_greater = 10 > 5</code> results in <code>True</code>. Boolean expressions like <code>5 == 5</code> or <code>7 < 3</code> are used to make decisions in programs. The <code>.2</code> means it will print upto 2 decimal points</p>
...
Example: <code>a = 10; b = 3; print(a + b, a - b, a * b, a / b, a % b, a ** b, a // b)</code></li>

<li><strong>Comparison Operators:</strong> Used to compare two values. Examples: <code>==</code> (equal), <code>!=</code> (not equal), <code>&gt;</code> (greater than), <code>&lt;</code> (less than), <code>&gt;=</code> (greater than or equal), <code>&lt;=</code> (less than or equal).<br>
Example: <code>x = 5; y = 8; print(x == y, x != y, x &gt; y, x &lt; y, x &gt;= y, x &lt;= y)</code></li>

<li><strong>Logical Operators:</strong> Used to combine Boolean values. Examples: <code>and</code>, <code>or</code>, <code>not</code>.<br>
Example: <code>p = True; q = False; print(p and q, p or q, not p)</code></li>

<li><strong>Assignment Operators:</strong> Used to assign values to variables. Examples: <code>=</code> assign value, <code>+=</code> add value then assign, <code>-=</code> subtract value then assign, <code>*=</code> multiply value then assign, <code>/=</code> divide then assign.<br>
Example: <code>num = 10; num += 5; print(num)</code></li>
...
<ul>
<li>Arithmetic Expression: <code>result = (10 + 5) * 2</code> → evaluates to <code>30</code></li>
<li>Comparison Expression: <code>is_equal = 10 == 5</code> → evaluates to <code>False</code></li>
<li>Logical Expression: <code>check = True and False</code> → evaluates to <code>False</code></li>
<li>Combined Expression: <code>final = (10 + 5) * 2 &gt; 20 and 5 != 3</code> → evaluates to <code>True</code></li>
</ul>
...
<p><strong>2. Comparison Expression:</strong> Compare two numbers using <code>==</code>, <code>!=</code>, <code>&gt;</code>, <code>&lt;</code>, <code>&gt;=</code>, <code>&lt;=</code>, and print the results.</p>
...
<p><strong>4. Assignment Expression:</strong> Use <code>=</code>, <code>+=</code>, <code>-=</code>, <code>*=</code>, <code>/=</code> on a variable and print the results.</p>
...
`,
            starterCode: '#Take a = 5, b = 2 then do all arithmetic operations given in task\n#Take any two variables and get expected output using comparison operators\n#Take any two variable and get expected output using logical operators\n#Do in the order of " = , += , -= , *= , /=" \n',
            expected_output: '7\n3\n10\n2.5\n1\n25\n2\nFalse\nTrue\nFalse\nTrue\nFalse\nTrue\nFalse\nTrue\nFalse\n10\n15\n10\n20\n5.0'
        },
        4: {
...
`,
        ...
        6: {
            ...
            starterCode: 'colors = ["red", "green", "blue"]\n# Your task: Print the second element from the colors list.\n',
        ...
        7: {
            ...
            starterCode: 'numbers = [1, 2, 3]\n# Your task: Use a for loop to print each number from the list.\n',
            expected_output: '1\n2\n3'
        },
        8: {
            title: '8. Functions',
            ...
            starterCode: 'count = 3\n# Your task: Use a while loop to print a countdown from 3 to 1.\n',
            expected_output: '3\n2\n1'
        },
        9: {
        ...
        11: {
            ...
            starterCode: 'def add(a, b):\n    # Your task: Return the sum of a and b.\n\nresult = add(5, 4)\nprint(result)',
            expected_output: '9'
        },
        12: {
            ...
            starterCode: 'user = {"name": "John", "city": "New York"}\n# Your task: Print the user\'s city.\n',
        ...
        13: {
            ...
            starterCode: 'message = "quest"\n# Your task: Convert the message to uppercase and print it.\n',
        ...
        14: {
            ...
            starterCode: 'alphabet = "abcdefg"\n# Your task: Slice the string to get the first 4 characters and print them.\n',
        ...
        17: {
            ...
            starterCode: 'item_name = "Potion"\n# Your task: Use an f-string to print "The item is a Potion".\n',
        ...
        18: {
            ...
            starterCode: 'items = [1, 2, 3]\n# Your task: Append the number 4 to the list.\n\nprint(items)',
        ...
        19: {
            ...
            starterCode: '# Your task: Wrap the following code in a try...except block to handle the error.\nresult = 10 / 0\nprint(result)',
...
<pre><code>int age = 20;         // Integer variable
...
<ul>
<li><strong>int:</strong> Stores integer numbers (positive or negative) without decimals. Example: <code>int a = 10;</code></li>
<li><strong>float:</strong> Stores decimal numbers (single precision). Example: <code>float b = 3.14;</code></li>
<li><strong>double:</strong> Stores decimal numbers with double precision. Example: <code>double pi = 3.141592;</code></li>
<li><strong>char:</strong> Stores a single character in single quotes. Example: <code>char grade = 'B';</code></li>
...
`,
        ...
        4: {
            ...
            starterCode: '#include <stdio.h>\n\nint main() {\n    int result = 120; // Complete the calculation\n    printf("%d", result);\n    return 0;\n}',
            expected_output: '70'
        },
        5: {
        ...
        17: {
            ...
            starterCode: '#include <stdio.h>\n\nint main() {\n    int a = 5;\n    int b = 2;\n    // Perform floating point division and print\n    return 0;\n}',
            expected_output: '2.500000'
        },
        18: {
            title: '18. Command Line Arguments',
            description: 'Passing data to your program on startup.',
            content: `<h2>Unchanging Variables</h2><p>You can create constants with the <code>const</code> keyword. Their value cannot be changed.</p><p><strong>Your Task:</strong> Create a constant integer <code>MAX_SCORE</code> with a value of 1000 and print it.</p>`,
            starterCode: '#include <stdio.h>\n\nint main() {\n    // Define and print the constant\n    return 0;\n}',
        ...
        20: {
            ...
            starterCode: '#include <stdio.h>\n\nconst char* get_final_message() {\n    // Return the correct string literal\n}\n\nint main() {\n    printf("%s", get_final_message());\n    return 0;\n}',
...
<p>Example of variable declaration and initialization:</p>
<pre><code>int age = 25;              // Integer variable
...
<ul>
<li><strong>int:</strong> Stores whole numbers without decimals. Example: <code>int a = 10;</code></li>
<li><strong>double:</strong> Stores decimal numbers with double precision. Example: <code>double pi = 3.14159;</code></li>
<li><strong>float:</strong> Stores decimal numbers with single precision. Example: <code>float price = 99.99f;</code></li>
<li><strong>char:</strong> Stores a single character. Example: <code>char grade = 'B';</code></li>
<li><strong>boolean:</strong> Stores true or false values. Example: <code>boolean isActive = true;</code></li>
<li><strong>String:</strong> Stores a sequence of characters (text). Example: <code>String name = "Alice";</code></li>
</ul>
...
Example: <code>int sum = 10 + 5; int product = 10 * 5;</code></li>

<li><strong>Comparison Operators:</strong> <code>==</code>, <code>!=</code>, <code>&gt;</code>, <code>&lt;</code>, <code>&gt;=</code>, <code>&lt;=</code>.<br>
Example: <code>boolean result = 10 &gt; 5;</code></li>

<li><strong>Logical Operators:</strong> <code>&&</code> (and), <code>||</code> (or), <code>!</code> (not).<br>
Example: <code>boolean check = (10 &gt; 5) && (5 &lt; 10);</code></li>

<li><strong>Assignment Operators:</strong> <code>=</code>, <code>+=</code>, <code>-=</code>, <code>*=</code>, <code>/=</code>.<br>
Example: <code>int a = 10; a += 5;  // a becomes 15</code></li>
</ul>
...
<p><strong>3. Comparison Operators:</strong> Compare two numbers using <code>&gt;</code>, <code>&lt;</code>, <code>==</code> and print the results.</p>
...
<p><strong>5. Assignment Operators:</strong> Use <code>+=</code>, <code>-=</code>, <code>*=</code> on a variable and print the results.</p>
...
`,
        ...
        7: {
            ...
            starterCode: 'public class Main {\n    public static void main(String[] args) {\n        char[] letters = {\'a\', \'b\', \'c\'};\n        // Use an enhanced for loop to print each letter\n    }\n}',
            expected_output: 'a\nb\nc'
        },
        8: {
            title: '8. Arrays & Strings',
        ...
        11: {
            ...
            content: `<h2>Initializing Objects</h2><p>A constructor is a special method called when an object is created. It\'s used to initialize the object\'s attributes.</p><p><strong>Your Task:</strong> The <code>Car</code> constructor sets the model. Create a new Car with the model "Tesla" and print its model.</p>`,
        ...
        16: {
            ...
            content: `<h2>The final keyword</h2><p>The <code>final</code> keyword can be used to declare a variable that cannot be changed. It creates a constant.</p><p><strong>Your Task:</strong> The code tries to change a final variable, which causes an error. Fix it by removing the line that reassigns the value, so it only prints the initial value.</p>`,
            starterCode: 'public class Main {\n    public static void main(String[] args) {\n        final int year = 2025;\n        year = 2026; // This line has an error!\n        System.out.println(year);\n    }\n}',
        ...
        18: {
            ...
            starterCode: 'import java.util.HashMap;\n\npublic class Main {\n    public static void main(String[] args) {\n        HashMap<String, String> capitals = new HashMap<String, String>();\n        capitals.put("England", "London");\n        capitals.put("Germany", "Berlin");\n        // Get and print the capital of England\n    }\n}',
    ...
    'rust': {
        ...
        13: {
            ...
            starterCode: 'fn main() {\n    let result: Result<i32, &str> = Ok(100);\n    // Match on the result and print the value\n}',
            expected_output: '100'
        },
        14: {
            title: '14. Generics',
...
<p>Explanation:</p>
<ul>
<li><code>WHERE department = 'HR'</code>: Filters the rows to include only employees whose <code>department</code> column is "HR".</li>
...
<pre><code>SELECT * 
FROM employees
WHERE department = 'IT' AND country = 'USA';</code></pre>

<p><strong>Example Using OR:</strong> Select employees who are either in "Finance" or from "HR".</p>
<pre><code>SELECT * 
FROM employees
WHERE department = 'Finance' OR department = 'HR';</code></pre>
...
<pre><code>SELECT * 
FROM employees
WHERE name = 'John' AND country = 'USA';</code></pre>
